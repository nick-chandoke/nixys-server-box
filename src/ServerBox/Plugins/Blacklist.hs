...
import Network.Wai (Response, remoteHost, responseLBS, responseStatus)
...
--
-- Remember to handle 'R.ConnectionLostException' and 'Network.Socket.Internal.throwSocketError' (an 'IOError' generated by 'Foreign.C.Error.throwErrno') (synchronously thrown on calls to 'R.runRedis')
checkBlacklist :: forall m
                . MonadIO m
